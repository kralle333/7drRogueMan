...
class ApplicationMain {
	...
	private static function preload() {
		...
		// assets:
		loadFile("assets/images/enemies/ghost.png");
		loadFile("assets/images/enemies/poison.png");
		loadFile("assets/images/enemies/poisonSlime.png");
		loadFile("assets/images/enemies/slime.png");
		loadFile("assets/images/enemies/soldier.png");
		loadFile("assets/images/enemies/thief.png");
		loadFile("assets/images/items/heart.png");
		loadFile("assets/images/items/killPotion.png");
		loadFile("assets/images/items/movePotion.png");
		loadFile("assets/images/items/shoes.png");
		loadFile("assets/images/items/sword.png");
		loadFile("assets/images/items/wand.png");
		loadFile("assets/images/items/yendor.png");
		loadFile("assets/images/map/amuletRoom.png");
		loadFile("assets/images/map/blocksCastle.png");
		loadFile("assets/images/map/blocksForest.png");
		loadFile("assets/images/map/blocksLast.png");
		loadFile("assets/images/map/coin.png");
		loadFile("assets/images/map/sack.png");
		loadFile("assets/images/map/stairway.png");
		loadFile("assets/images/player.png");
		loadFile("assets/images/selectedbutton.png");
		loadBinary("assets/images/shoes.ase");
		loadFile("assets/images/tombstone.png");
		loadBinary("assets/music/music-goes-here.txt");
		loadSound("assets/sounds/buy.wav");
		loadSound("assets/sounds/coin.wav");
		loadSound("assets/sounds/dead.wav");
		loadSound("assets/sounds/itemUse.wav");
		loadSound("assets/sounds/kill.wav");
		loadSound("assets/sounds/sack.wav");
		loadBinary("assets/sounds/step1.aup");
		loadSound("assets/sounds/step1.wav");
		loadBinary("assets/sounds/step1_data/e00/d00/e000000f.au");
		loadBinary("assets/sounds/step1_data/e00/d00/e000005e.au");
		loadBinary("assets/sounds/step1_data/e00/d00/e0000094.au");
		loadBinary("assets/sounds/step1_data/e00/d00/e00000c5.au");
		loadBinary("assets/sounds/step1_data/e00/d00/e0000261.au");
		loadBinary("assets/sounds/step1_data/e00/d00/e0000652.au");
		loadBinary("assets/sounds/step1_data/e00/d00/e000087c.au");
		loadBinary("assets/sounds/step1_data/e00/d00/e0000a63.au");
		loadBinary("assets/sounds/step1_data/e00/d00/e0000b60.au");
		loadBinary("assets/sounds/step1_data/e00/d00/e0000b9d.au");
		loadBinary("assets/sounds/step1_data/e00/d00/e0000c3f.au");
		loadBinary("assets/sounds/step1_data/e00/d00/e0000d1a.au");
		loadBinary("assets/sounds/step1_data/e00/d00/e0000d51.au");
		loadSound("assets/sounds/step2.wav");
		loadSound("assets/sounds/step3.wav");
		loadSound("assets/sounds/step4.wav");
		loadBinary("assets/sounds/steps.aup");
		loadSound("assets/sounds/steps.wav");
		loadBinary("assets/sounds/steps_data/e00/d00/e0000011.au");
		loadSound("assets/sounds/yendor.wav");
