...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "7drRogueMan", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "7drRogueMan", null, { width: 820, height: 640 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 820, height: 640 });
			#end
