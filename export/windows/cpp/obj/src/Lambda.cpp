...
Dynamic Lambda_obj::array( Dynamic it){
	HX_STACK_FRAME("Lambda","array",0x9c8b0512,"Lambda.array","D:\\Programs\\Haxe\\haxe\\std/Lambda.hx",42,0xd47757c4)
	HX_STACK_ARG(it,"it")
	HX_STACK_LINE(43)
...
bool Lambda_obj::has( Dynamic it,Dynamic elt){
	HX_STACK_FRAME("Lambda","has",0x3d8bd693,"Lambda.has","D:\\Programs\\Haxe\\haxe\\std/Lambda.hx",98,0xd47757c4)
	HX_STACK_ARG(it,"it")
